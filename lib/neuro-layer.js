...
var NeuroLayer = function (config) {
	 ...
	 * @return {NeuroLayer} - A self reference
	 *
	 * @todo  change feeding cells into feeding synapses, where a synapse is a pair of a feeding cell 
	 *   and an associated permanence value or weight respectively? also have a list of potential synapses.
	 *   then get feeding cell is actually given by feedingsynapses.map(getcellofsynapse)...
	 */
